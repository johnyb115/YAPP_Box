...
pcbLength           = 118.5; // front to back (X axis)
pcbWidth            = 105.5; // side to side (Y axis)
pcbThickness        = 1.6; 
...
pcbStands = 
[
    [3.2+3.4/2, 2.65+3.4/2,  yappBoth, yappPin, yappFrontLeft]
   ,[3.2+3.4/2, 6.5+3.4/2,  yappPin, yappBoth, yappFrontRight]
   ,[9.4+3.4/2, 2.65+3.4/2,  yappBoth, yappPin, yappBackLeft]
   ,[9.4+3.4/2, 6.5+3.4/2,  yappBackRight, yappPin, yappBoth]
];
...
connectors   =
[
    [-6, 46.5, standoffHeight
     , 3.1    //-- diameter of the screw (add some slack)
     , 5      //-- the diameter of the screw head
     , 4.1    //-- the diameter of the insert
     , 9
     , yappCoordPCB],     //-- the outside diameter of the connector
    [124.5, 46.5, standoffHeight
     , 3.1    //-- diameter of the screw (add some slack)
     , 5      //-- the diameter of the screw head
     , 4.1    //-- the diameter of the insert
     , 9
...
cutoutsFront =  
[
  [27, 22, 30, 30, 0, yappRectangle,maskHoneycomb, yappDefault,   0, yappCenter]
  ,[71, 22, 30, 30, 0, yappRectangle,maskHoneycomb, yappDefault,   0, yappCenter]
];


cutoutsBack = 
[
  [10, -4, 30, 30, 0, yappRectangle, maskHoneycomb, yappCoordPCB]
];
...
[
   ...
   [39.5,12, 0,  0,  3.5, yappCircle, yappCenter, yappCoordBox]
     //-- [B] Make the rounded rect thru the end of the ridge extansion
   ,[58,13, 12, 3,  2, yappRoundedRect, yappCenter, yappCoordBox]
];
...
[
  ...
  //--     of the box
  [36, 7, 12, yappCoordBox]
  ,[52, 12, 12, yappCoordBox]
];
